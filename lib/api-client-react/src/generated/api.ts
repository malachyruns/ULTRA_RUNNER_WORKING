...
import type {
  ...
  PortalAutoCreateRaceImport200,
  PortalAutoCreateRaceImportBody,
  Race,
  RaceInput,
  RaceUpdate,
  Result,
  ...
  RunnerStats,
  RunnerUpdate,
  ScrapeAndCreateRaceInput,
  ScrapeCreateImportResponse,
...
export const getPortalAutoCreateRaceImportUrl = () => {




  return `/api/portal/scrape-import`
}

/**
 * @summary Create a race and import results from a URL
 */
export const portalAutoCreateRaceImport = async (portalAutoCreateRaceImportBody: PortalAutoCreateRaceImportBody, options?: RequestInit): Promise<PortalAutoCreateRaceImport200> => {

  return customFetch<PortalAutoCreateRaceImport200>(getPortalAutoCreateRaceImportUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getPortalAutoCreateRaceImportMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof portalAutoCreateRaceImport>>, TError,{data: BodyType<PortalAutoCreateRaceImportBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof portalAutoCreateRaceImport>>, TError,{data: BodyType<PortalAutoCreateRaceImportBody>}, TContext> => {

const mutationKey = ['portalAutoCreateRaceImport'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof portalAutoCreateRaceImport>>, {data: BodyType<PortalAutoCreateRaceImportBody>}> = (props) => {
          const {data} = props ?? {};

          return  portalAutoCreateRaceImport(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PortalAutoCreateRaceImportMutationResult = NonNullable<Awaited<ReturnType<typeof portalAutoCreateRaceImport>>>
    export type PortalAutoCreateRaceImportMutationBody = BodyType<PortalAutoCreateRaceImportBody>
    export type PortalAutoCreateRaceImportMutationError = ErrorType<unknown>

    /**
 * @summary Create a race and import results from a URL
 */
export const usePortalAutoCreateRaceImport = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof portalAutoCreateRaceImport>>, TError,{data: BodyType<PortalAutoCreateRaceImportBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof portalAutoCreateRaceImport>>,
        TError,
        {data: BodyType<PortalAutoCreateRaceImportBody>},
        TContext
      > => {
      return useMutation(getPortalAutoCreateRaceImportMutationOptions(options));
    }
...
export const getPortalScrapeCreateImportUrl = () => {




  return `/api/portal/races/scrape-create-import`
}

/**
 * @summary Scrape a URL, create a new race from the given details, and import the results
 */
export const portalScrapeCreateImport = async (scrapeAndCreateRaceInput: ScrapeAndCreateRaceInput, options?: RequestInit): Promise<ScrapeCreateImportResponse> => {

  return customFetch<ScrapeCreateImportResponse>(getPortalScrapeCreateImportUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getPortalScrapeCreateImportMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof portalScrapeCreateImport>>, TError,{data: BodyType<ScrapeAndCreateRaceInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof portalScrapeCreateImport>>, TError,{data: BodyType<ScrapeAndCreateRaceInput>}, TContext> => {

const mutationKey = ['portalScrapeCreateImport'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof portalScrapeCreateImport>>, {data: BodyType<ScrapeAndCreateRaceInput>}> = (props) => {
          const {data} = props ?? {};

          return  portalScrapeCreateImport(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PortalScrapeCreateImportMutationResult = NonNullable<Awaited<ReturnType<typeof portalScrapeCreateImport>>>
    export type PortalScrapeCreateImportMutationBody = BodyType<ScrapeAndCreateRaceInput>
    export type PortalScrapeCreateImportMutationError = ErrorType<void>

    /**
 * @summary Scrape a URL, create a new race from the given details, and import the results
 */
export const usePortalScrapeCreateImport = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof portalScrapeCreateImport>>, TError,{data: BodyType<ScrapeAndCreateRaceInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof portalScrapeCreateImport>>,
        TError,
        {data: BodyType<ScrapeAndCreateRaceInput>},
        TContext
      > => {
      return useMutation(getPortalScrapeCreateImportMutationOptions(options));
    }
